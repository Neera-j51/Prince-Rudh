...
module.exports = {
    ...
    SESSION: process.env.PRINCE_SESSION === undefined ? '' : process.env.PRINCE_SESSION,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? ' PƦł₦₡EƦUÐҤ' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🎸PƦł₦₡EƦUÐҤ ÐØ₩₦ŁØÐł₦G ¥ØUƦ $Ø₦G✮⃝🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸PƦł₦₡EƦUÐҤ UPŁØλÐł₦G ¥ØUƦ $Ø₦G✮⃝🎧' : process.env.SONGU,
    ...
    LOGO: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/G1a03O8.jpeg' : process.env.LOGO_LINK,
    BGMD: process.env.BGM_DURATION === undefined ? '39999600' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ɪͥᴛͭsᷤ ᴍͫᴇͤ☚⃟፝༄PƦł₦₡EƦUÐҤ☚⃟፝࿐' : process.env.BOTV2_NAME,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/18620a468bb4d18bacd0d.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ᴘʀɪɴᴄᴇʀᴜᴅʜ ʙᴏᴛ' : process.env.LOGO_NAME,
