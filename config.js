...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By RDX V2' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '18254138025@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? ' 𝐑𝐃𝐗 𝐕𝟐࿐ ' : process.env.BOT_NAME,
    ...
    LIZA: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/xihfXRE.jpeg' : process.env.LOGO_LINK,
    MWOL: process.env.BGM_DURATION === undefined ? '39999600' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ʀᴅx ʙᴏᴛ࿐' : process.env.BOTV2_NAME,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ʀᴅx ʙᴏᴛ࿐' : process.env.LOGO_NAME,
